...
export const PREFECTURE_INFO = {
  ...
  yamagata:  { label: '山形',   emblem: '山', region: 'tohoku' },
  ...
  yamanashi: { label: '山梨',   emblem: '山', region: 'chubu' },
  ...
  ehime:     { label: '愛媛',   emblem: '愛', region: 'shikoku' },
  ...
  yamaguchi: { label: '山口',   emblem: '山', region: 'chugoku' },
  // 九州・沖縄
  fukuoka:   { label: '福岡',   emblem: '福', region: 'kyushu' },
  saga:      { label: '佐賀',   emblem: '佐', region: 'kyushu' },
  nagasaki:  { label: '長崎',   emblem: '長', region: 'kyushu' },
  kumamoto:  { label: '熊本',   emblem: '熊', region: 'kyushu' },
  oita:      { label: '大分',   emblem: '大', region: 'kyushu' },
...
export const REGIONS = [
  ...
  },
  {
    ...
    prefectures: [
      ...
      { id: 'yamanashi', label: '山梨', emblem: '山' },
  ...
  },
  {
    ...
    prefectures: [
      ...
      { id: 'yamaguchi', label: '山口', emblem: '山' },
    ],
  },
  {
    id: 'shikoku',
